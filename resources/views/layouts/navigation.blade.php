        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('coupon.my_coupon')" :active="request()->routeIs('coupon.my_coupon')">
                        Мой купон
                    </x-nav-link>

                    <x-nav-link :href="route('coupon.test_coupon')" :active="request()->routeIs('coupon.test_coupon')">
                        Проверить купон
                    </x-nav-link>
                </div>
            </div>
